...
if(isset($_POST['update'])){
   ...
   if(!empty($old_password) || !empty($new_pass) || !empty($confirm_pass)){
      if($new_pass!=$old_password){
         $message[] = 'old password not matched';
      }else if($new_pass!=$confirm_pass){
         $message[] = 'confirm password not matched';
      }else{
         $update_password=$conn->prepare("UPDATE 'users' SET  pass=? WHERE id=?");
...
<section class="update-profile-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <input type="hidden" name="old_pass" value="<?php= $fetch_profile['password']; ?>">
